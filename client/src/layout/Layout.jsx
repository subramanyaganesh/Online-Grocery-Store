...
const Layout = ({ children, title, loading }) => {
  return (
    <>
      <Helmet>
        <meta charSet="utf-8" />
        <title>{title || "Home"} | Online Grocery Store </title>
        <meta
          name="description"
        ...
        <meta property="og:title" content="Online Grocery Store" />
        <meta
          property="og:description"
          content="E-commerce store built with React, Node, Express and Postgres"
        />
        <meta property="og:url" />
        <meta property="og:site_name" content="Online Grocery Store" />
        ...
        <meta
          ...
          content="E-commerce store built with React, Node, Express and Postgres"
        />
        <meta name="twitter:title" content="Online Grocery Store" />
      ...
      <div className="min-h-screen flex flex-col">
        ...
        <footer className="mt-auto flex justify-center py-2">
          <p className="text-sm text-gray-600 sm:ml-4 sm:pl-4 sm:py-2 sm:mt-0 mt-4">
            &copy; {new Date().getFullYear()} Online Grocery Store —
            <a
